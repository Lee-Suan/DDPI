    ...
    <section id="services" className="bg-zinc-950">
      <div className="section-padding">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl md:text-3xl mb-4 break-keep">주요 서비스</h2>
          <p className="text-slate-300 text-sm font-light break-keep">전문성과 경험을 바탕으로 최상의 솔루션을 제공합니다.</p>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="h-full glass-card p-8">
                <div className="bg-secondary w-10 h-10 rounded-xl flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(139,92,246,0.3)] group-hover:bg-accent-green group-hover:shadow-[0_0_20px_rgba(74,222,128,0.5)] transition-all">
                  {icons[index % icons.length]}
                </div>
                <h3 className="text-base mb-6 text-white group-hover:text-accent-green transition-colors font-bold">{service.title}</h3>
