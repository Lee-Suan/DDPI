          ...
          {areas.map((area, index) => (
            ...
            >
              ...
              <div className="p-5 md:p-6 relative">
                <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-secondary/5 rounded-full blur-3xl group-hover:bg-secondary/10 transition-all duration-500"></div>
                
                <h3 className="text-xl md:text-2xl mb-3 font-bold group-hover:text-secondary transition-colors break-keep text-gradient-secondary flex items-center gap-3">
                  <div className="p-2 bg-white/5 rounded-lg group-hover:bg-secondary/20 transition-all duration-500 border border-white/10 shrink-0">
                    {React.cloneElement(area.icon as React.ReactElement, { size: 20, className: "text-secondary" })}
                  </div>
                  {area.title}
                </h3>
